...
/usr/bin/chromium --kiosk --password-store=basic --use-mock-keychain --disable-translate --user-data-dir=/tmp/chromium-touch --window-position=0,0 http://localhost:3000/ui/touch.html &
...
/usr/bin/chromium --kiosk --password-store=basic --use-mock-keychain --disable-translate --user-data-dir=/tmp/chromium-tv --window-position=1280,0 http://localhost:3000/ui/tv.html &
